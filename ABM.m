...
L=0; b_i0 = sum(randi(5,m_i0,1)); Tmax=100; dt = 0.0001; yo=[b_i0, b_e0, m_u0, m_i0, n0, L]; 
...
plotscomparison(Plots_comparison,Ti,Tie,Bie,BiA,Bee,BeA,Mue,MuA,Mie,MiA,Nvectore,NA);
